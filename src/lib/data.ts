...
export const devProjects: Project[] = [
  ...
  },
  {
    name: "Konkan",
    description:
      "Interactive Konkan coast tourism platform — explore beaches, heritage forts, cuisine, and travel routes with dynamic destination galleries and seamless navigation.",
    overview:
      "A fully deployed Konkan tourism showcase built with modern web technologies. Features interactive destination galleries, heritage site information, local cuisine highlights, and optimised for mobile-first travel planning.",
    highlights: [
      "Interactive destination galleries with beautiful imagery",
      "Comprehensive Konkan region travel information",
      "Mobile-optimised responsive design for travellers",
    ],
    stack: ["React", "Next.js", "TypeScript", "Tailwind CSS"],
    category: "fullstack",
    tier: "Featured",
    github: "https://github.com/DivyangP2003/konkan",
    demo: "https://konkan-konkan.vercel.app",
    featured: true,
    image: "/projects/konkan-1-hero.png",
    images: [
      "/projects/konkan-1-hero.png",
      "/projects/konkan-2-featured.png",
      "/projects/konkan-3-content.png",
      "/projects/konkan-4-details.png",
    ],
  },
  {
